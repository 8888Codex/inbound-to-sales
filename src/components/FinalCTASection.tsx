...
export const FinalCTASection = () => {
  ...
  return (
    <section className="py-24 px-4 md:px-6 bg-gradient-to-br from-primary via-primary/95 to-accent relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <Badge
          variant="secondary"
          className="mb-6 bg-urgency text-urgency-foreground border-urgency/30 px-4 py-1.5 text-sm font-bold animate-pulse shadow-lg flex items-center gap-1.5"
        >
          <AlertIcon />
          Vagas Limitadas
        </Badge>
        ...
        <p className="text-white/95 text-xl md:text-2xl mb-6 font-medium">
          Próxima turma <span className="font-bold text-accent">26 DE NOVEMBRO ÀS 19H</span>
        </p>

        <div className="bg-white/15 backdrop-blur-md border-2 border-white/30 rounded-2xl p-6 md:p-8 mb-10 inline-block shadow-2xl hover:bg-white/20 transition-all duration-300">
          <div className="flex items-center justify-center gap-2 text-white mb-2">
            <div className="text-accent w-6 h-6">
              <GiftIcon />
            </div>
            <p className="font-bold text-lg md:text-xl">Bônus Exclusivo</p>
          </div>
        ...
        <Button
          ...
          className="bg-gradient-to-r from-accent via-accent to-accent-hover hover:from-accent-hover hover:via-accent-hover hover:to-accent text-accent-foreground font-bold text-lg md:text-xl px-12 py-7 h-auto rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 group mb-10"
        >
